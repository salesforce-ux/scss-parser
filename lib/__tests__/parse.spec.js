...
describe('atrule', () => {
  ...
  it('mixin 1 arbitrary keyword arg 1 declaration', () => {
    const ast = createAST('@mixin myMixin($a...) { color: red; }')
    expect(ast).toMatchSnapshot()
  })
  it('mixin 1 required arg 1 arbitrary keyword arg 1 declaration', () => {
    const ast = createAST('@mixin myMixin($a, $b...) { color: red; }')
    expect(ast).toMatchSnapshot()
  })
})
describe('sink', () => {
